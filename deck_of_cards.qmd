...
Project 3 Task: Calculate a probability non-trivial to simulation that contains at least one original function, at least 1 map() variant, at least 1 illustrative, well-labeled plot, and a description of what insights can be gained from that plot. 
